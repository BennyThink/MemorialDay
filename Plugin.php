 ...
 * @author Benny
 * @version 1.0.0
 * @link https://www.bennythink.com/
 */
/* 激活插件方法 */
class MemorialDay_Plugin implements Typecho_Plugin_Interface
{
    public static function activate(){
        Typecho_Plugin::factory('Widget_Archive')->header = array('MemorialDay_Plugin', 'submit');
        return _t('插件已启用');
    }
...
07-13', _t('纪念日日期'), _t('填入形如07-13日期，一行一个'));
    ...
    public static function submit(){
       $CustomDate=Typecho_Widget::widget('Widget_Options')->plugin('MemorialDay')->word;
       $HexColor=Typecho_Widget::widget('Widget_Options')->plugin('MemorialDay')->word2;
